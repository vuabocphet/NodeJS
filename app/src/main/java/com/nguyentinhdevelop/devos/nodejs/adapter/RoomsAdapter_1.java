...
public class RoomsAdapter_1 extends RecyclerView.Adapter<ViewHolderRooms> {
    private MainActivity context;
    private ArrayList<roomModel> list=new ArrayList<>();
    private ArrayList<hotelModel> listHotel=new ArrayList<>();

    public RoomsAdapter_1(MainActivity context, ArrayList<roomModel> list, ArrayList<hotelModel> listHotel) {
